 ...
 * states that there should be a connection A->B, there will always be a single {@link ConnectionManager}.
 * {@link Connection}s could break and be re-established, but they will always go though this single point.
 */
public interface ConnectionManager {
     ...
     * <p>
     * **NOTE** <br/> It is used only for unit testing, should never be called from production code, as it skips all
     * thread safety
     * </p>
     *
     ...
     * @throws InterruptedException thrown if the thread is interrupted while handing over the new connection
     */
     ...
     *
     * @return true if connection is outbound (we connect to remote node), false if we are listening for incoming
     * connection
     */
    boolean isOutbound();
}
