 ...
 */
public class SyncInputStreamImpl extends SerializableDataInputStream implements SyncInputStream {

    private final ByteCounter byteCounter;

    private SyncInputStreamImpl(@NonNull final InputStream in, @NonNull final ByteCounter byteCounter) {
        super(in);
        this.byteCounter = byteCounter;
    }

    /**
     * Create a new {@link SyncInputStreamImpl} that optionally decompresses the data using gzip compression and
     ...
     * @return a new {@link SyncInputStreamImpl}
     */
    public static SyncInputStreamImpl createSyncInputStream(
        ...
        return new SyncInputStreamImpl(wrappedStream, meteredStream.byteCounter());
    }
