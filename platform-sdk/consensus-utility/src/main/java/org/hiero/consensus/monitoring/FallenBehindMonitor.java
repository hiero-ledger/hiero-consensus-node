...
public class FallenBehindMonitor {
    ...
    public FallenBehindMonitor(@NonNull final Roster roster, @NonNull final Configuration configuration, @NonNull final NodeId selfId) {
        final double fallenBehindThreshold = configuration.getConfigData(FallenBehindConfig.class).fallenBehindThreshold();
