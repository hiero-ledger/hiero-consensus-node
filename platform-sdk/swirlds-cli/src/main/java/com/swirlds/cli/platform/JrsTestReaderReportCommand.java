...
public class JrsTestReaderReportCommand extends AbstractCommand {
    ...
    private JrsTestReaderReportCommand() throws URISyntaxException, IOException {
        URL url = this.getClass().getResource("/testMetadata.csv");
        Map<String, String> env = Map.of("create", "true");
        FileSystem zipfs = FileSystems.newFileSystem(url.toURI(), env);
        this.metadataFile = Paths.get(url.toURI());
    }
