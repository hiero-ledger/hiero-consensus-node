...
| [SCN-004](SCN-004-origin-gate-discards-relearned-self-event.md)  | Origin-gated self-event recency discards a self event relearned through gossip after an unclean shutdown — branching       | SYM-003  | event-creator, restart-and-pces | test-reproduced | verified |
