...
| RUL-003 | Every node contributing to consensus is independently restartable                                                   | state-machine | reconnect, event-creator, restart-and-pces, signed-state-management | holds  |
