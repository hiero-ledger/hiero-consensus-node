...
| RUL-003 | A reconnected node must write the learned state to disk before it resumes creating events                           | state-machine | reconnect, event-creator, restart-and-pces, signed-state-management | holds  |
