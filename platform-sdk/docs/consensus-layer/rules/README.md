...
| RUL-006 | The event creator keys latest-self-event tracking on nGen, so a re-received self-ancestor cannot become the self-parent | protocol   | event-creator                                                       | holds  |
