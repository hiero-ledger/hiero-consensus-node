...
- Invariants — INV-008 — consensus, once reached, is permanent; INV-013 — the minimum non-ancient round never decreases; INV-005 — every honest event eventually reaches consensus or becomes stale.
