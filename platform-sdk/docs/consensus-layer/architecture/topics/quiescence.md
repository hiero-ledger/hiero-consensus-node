...
- Invariants — INV-005 — every honest event eventually reaches consensus or becomes stale; INV-004 — staleness is agreed by all nodes (together the basis for the balanced-count requirement above). No invariant is tagged to the quiescence topic itself.
