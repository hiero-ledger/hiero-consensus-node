...
| `topics/iss-detection.md`                   | ISS detection                   | Per-round comparison of the local state hash against peer signatures, classification of any disagreement, and the configured halt or restart response. |
