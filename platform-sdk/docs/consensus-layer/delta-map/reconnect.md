...
|---|---|---|---|---|
| Execution owns reconnect; Consensus destroyed and recreated | Reconnect is an Execution procedure; the Consensus instance is torn down on falling behind and re-initialized afterwards. | Reconnect remains implemented inside consensus-layer modules; interim development there follows the reconnect-refactor proposal. | **not-started** | `ReconnectController`, `ReconnectCoordinator` (`consensus-reconnect-impl`) |
