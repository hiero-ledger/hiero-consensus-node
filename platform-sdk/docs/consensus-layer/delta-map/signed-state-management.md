...
| Signature collection owned by Execution | Execution collects and validates round signatures. | [§ Lifecycle of the Consensus Module](../../proposals/consensus-layer/Consensus-Layer.md#lifecycle-of-the-consensus-module), [§ Assumptions](../../proposals/consensus-layer/Consensus-Layer.md#assumptions) | The collector remains in platform-core; hedera-app only observes signatures. | **not-started** | `StateSignatureCollector`, `DefaultStateSignatureCollector` (`swirlds-platform-core`) — pre-proposal shape intact |
| State saving owned by Execution | Execution decides when to save and performs state persistence. | [§ Lifecycle of the Consensus Module](../../proposals/consensus-layer/Consensus-Layer.md#lifecycle-of-the-consensus-module), [§ Assumptions](../../proposals/consensus-layer/Consensus-Layer.md#assumptions) | Save decision and snapshot writing live in platform-core. | **not-started** | `DefaultSavedStateController`, `DefaultStateSnapshotManager` (`swirlds-platform-core`) — pre-proposal shape intact |
