...
checking), consensus-model (freeze statuses), consensus-transaction-handling
(the freeze-round handoff), consensus-state (freeze-state save), and
hedera-app, which already owns the freeze-metadata and upgrade-action side.
