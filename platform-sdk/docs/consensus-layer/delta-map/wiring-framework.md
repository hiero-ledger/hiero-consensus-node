...
| Wiring hidden behind an Execution-constructed Consensus facade | Execution creates and destroys Consensus instances; wiring is not visible at the boundary. | [§ Design](../../proposals/consensus-layer/Consensus-Layer.md#design), [§ Lifecycle of the Consensus Module](../../proposals/consensus-layer/Consensus-Layer.md#lifecycle-of-the-consensus-module) | Component composition lives in the consensus layer; Execution does not construct the Consensus library. | **not-started** | `SwirldsPlatform`, `PlatformBuilder` (`swirlds-platform-core`) — pre-proposal orchestration intact |
