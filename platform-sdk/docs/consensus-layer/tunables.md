...
| TUN-081 | `state.saveStateAsync`                | boolean  | `true`  | If true, periodic and freeze state snapshots are created asynchronously (perf optimization for high TPS / large state).                       |       | —         |
