...
- Invariants: INV-013 (the minimum non-ancient round never decreases — the ancient boundary only moves forward), INV-004 (a stale event is never ordered on any node).
