...
This is the existence/liveness claim for judges. Agreement on *which* events are the judges of a round is INV-007; the strengthening that the judges form a supermajority of stake is INV-014.
