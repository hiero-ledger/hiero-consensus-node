...
| [INV-005](INV-005-honest-event-eventually-reaches-consensus-or-stale.md)       | Every honest event eventually reaches consensus or becomes stale (probability 1)          | liveness  | hashgraph               | enforced |
...
| [INV-010](INV-010-active-address-book-never-moves-backward.md)                 | The active address book never moves backward                                              | safety    | hashgraph               | enforced |
