...
import org.hiero.consensus.wiring.framework.model.internal.standard.HeartbeatTask;
...
public class DeterministicHeartbeatScheduler extends AbstractHeartbeatScheduler {
     ...
     */
    public DeterministicHeartbeatScheduler(@NonNull final TraceableWiringModel model, @NonNull final Time time) {
        super(model, time);
    }
