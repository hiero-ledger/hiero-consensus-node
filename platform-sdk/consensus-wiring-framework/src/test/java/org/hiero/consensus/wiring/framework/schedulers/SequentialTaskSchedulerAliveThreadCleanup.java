...
/**
 * {@link SequentialThreadTaskScheduler}
 *  has the potential issue that if the {@link WiringModel} is not closed after the test finishes, it can leak the blocked thread up to when the JVM is shutdown.
