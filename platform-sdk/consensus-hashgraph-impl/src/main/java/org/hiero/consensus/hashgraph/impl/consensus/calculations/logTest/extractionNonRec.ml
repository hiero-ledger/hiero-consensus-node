...
let nodes =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.nodes)"

(** val stake : roundInfo -> node -> int **)

let stake =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.stake)"
...
let timeCreated =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.timeCreated)"

(** val creator : event -> node **)

let creator =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.creator)"

(** val birthRound : event -> int **)

let birthRound =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.birthRound)"

(** val selfParentSigned : event -> event option **)

let selfParentSigned =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.selfParentSigned)"

(** val otherParentsSigned : event -> event list **)

let otherParentsSigned =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.otherParentsSigned)"

(** val prevJudges : roundInfo -> event list **)

let prevJudges =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.prevJudges)"

(** val coinInterval : roundInfo -> int **)

let coinInterval =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.coinInterval)"

(** val targetNumRoundsNonAncient : roundInfo -> int **)

let targetNumRoundsNonAncient =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.targetNumRoundsNonAncient)"
...
let judgeCon1 =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.judgeCon1)"
...
let seeNum =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.seeNum)"

(** val seeDen : roundInfo -> int **)

let seeDen =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.seeDen)"

(** val coin : event -> node option **)

let coin =
  failwith "AXIOM TO BE REALIZED (Hashgraph.Hashgraph.coin)"
...
let decider =
  failwith "AXIOM TO BE REALIZED (Hashgraph.ConsensusOrder.decider)"
