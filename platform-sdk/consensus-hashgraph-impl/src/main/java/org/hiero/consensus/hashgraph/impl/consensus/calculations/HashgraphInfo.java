...
public final class HashgraphInfo {
    ...
    public static final class EventInfo {
         ...
         * consensus but can be useful for testing / debugging / monitoring. The coin field should be randomly
         * generated when the event is created, before it is signed. It should be a uniform random int in the range
         * [0,numNodes], inclusive, based on the number of nodes for the round that matches the birthRound. But it is
         * also OK to choose it as a uniform random int. It should be generated by a CSPRNG seeded by a TRNG. After
         * this is instantiated, never change an element in its parents array.
         *
