...
public final class Mnemonics {
    ...
    /**
     * In-order BIP-39 words. <a href="https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt">Source</a>
     */
    ...
    private static final List<String> wordList = List.of(words);
    ...
    /**
     * Get a list of BIP39 words, in order.
     *
     * @return a list of BIP39 words
     */
    ...
    public static String getWord(final long index) {
        return words[(int) (Math.abs(index) % words.length)];
    }
    ...
    public static int getWordIndex(final String word) {
        final Integer index = wordMap.get(word);
        if (index == null) {
            throw new IllegalArgumentException("Invalid BIP-39 word: " + word);
        }
        return index;
    }
    ...
    /**
     * <p>
     * Generate a list of mnemonic words from a byte array.
     * </p>
     *
     * <p>
    ...
    public static List<String> generateMnemonicWords(@NonNull final byte[] data, final int wordCount) {
        ...
        while (mnemonics.size() < wordCount) {
            ...
            // We only extract 11 bits of data from every 16 bits of entropy.
            // Not a big deal, if we run out of entropy we can hash it and continue.
            mnemonics.add(getWord(byteArrayToShort(entropy, nextIndex)));
    ...
    public static String generateMnemonic(final byte[] data, final int wordCount, final String separator) {
        return formattedList(generateMnemonicWords(data, wordCount).iterator(), separator);
    }
