...
public class PlatformStateInitializer {
    ...
    private static SwirldMain<?> createHederaApp(PlatformContext platformContext, SwirldMain<?> appMain) {
        ...
        try {
            ...
            hederaApp = (SwirldMain<?>) newHederaMethod.invoke(
                    null, noOpMetrics, DEFAULT_PLATFORM_STATE_FACADE, platformContext.getConfiguration());
