...
public interface GossipRpcSender {
    ...
    /**
     * Send information that we have fallen behind and don't want to sync anymore; reconnect protocol will
     * take precedence on next iteration
     * Remote state will be cleared if we ever {@link #sendSyncData(SyncData)} again
     */
    void sendFallenBehind();
