 ...
 */
public class DefaultUptimeTracker implements UptimeTracker {
     ...
     */
    public DefaultUptimeTracker(@NonNull final PlatformContext platformContext) {
     ...
     */
    @Override
    public void trackRound(@NonNull final ConsensusRound round) {
        ...
        final Map<NodeId, ConsensusEvent> lastEventsInRoundByCreator = round.getConsensusEvents().stream()
                .collect(Collectors.toMap(PlatformEvent::getCreatorId, e -> e, (e1, e2) -> e2));
