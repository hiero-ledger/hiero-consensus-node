...
public class ReconnectStateLearner {
    ...
    private ReservedSignedState reconnect() throws InterruptedException {
        ...
        final SignedState newSignedState = new SignedState(
                ...
                false,
                false);
        // FUTURE WORK: stateLifecycleManager must exclusively manage reference counts to remove
        // the necessity of the following adjustment. In this case `SignedState` constructor created
        // a redundant reservation
        receivedStateCopy.release();
