...
../../../../../../../../swirlds-cli/pcli.sh diagram \
    ...
    -g 'Consensus Engine:ConsensusEngine,EventWindowManager,RoundsToCesEvents' \
    ...
    -g 'Hashgraph Module:Consensus Engine,staleEventsSplitter,staleEvents,ConsensusRoundsSplitter,consensusRounds,preconsensusEvents,PreconsensusEventsSplitter,🌀,🕐' \
