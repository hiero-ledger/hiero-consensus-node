...
class GossipRpcShadowgraphSynchronizerTest {
    ...
    public static final SyncData EMPTY_SYNC_MESSAGE =
            new SyncData(EventWindow.getGenesisEventWindow(BIRTH_ROUND_THRESHOLD), List.of());
    ...
    void testSetup() throws Exception {
        ...
        this.shadowgraph.updateEventWindow(EventWindow.getGenesisEventWindow(BIRTH_ROUND_THRESHOLD));
    ...
    void testFallenBehind() {
        ...
        conversation.receiveSyncData(
                new SyncData(new EventWindow(100, 101, 1000, 800, BIRTH_ROUND_THRESHOLD), List.of()));
