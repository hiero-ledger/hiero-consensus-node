...
class StateLifecycleManagerTests {
    ...
    @Test
    @DisplayName("initState on initialized state")
    void initStateOnInitializedState() {
        assertThrows(IllegalStateException.class, () -> stateLifecycleManager.initState(initialState));
    }
