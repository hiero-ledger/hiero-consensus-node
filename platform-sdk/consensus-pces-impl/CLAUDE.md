...
Allowed consensus-layer dependencies: `consensus-pces` (its API); `consensus-state`; supporting
modules `consensus-model`, `consensus-concurrent`, `consensus-metrics`, `consensus-utility`.
