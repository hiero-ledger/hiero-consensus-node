...
/**
 * This class provides the common functionality for writing preconsensus events to disk.
 */
public class CommonPcesWriter {
     ...
     *
     * @param minimumBirthRoundToStore the minimum ancient indicator required to be stored on disk
     */
