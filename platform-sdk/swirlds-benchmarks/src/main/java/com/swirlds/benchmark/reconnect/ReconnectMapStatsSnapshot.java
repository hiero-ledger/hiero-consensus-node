 ...
 * algorithm. Values are keyed by the names registered in the metrics system, allowing reconnect metric changes to be
 * captured without maintaining a duplicate fixed schema in the benchmark.
 *
