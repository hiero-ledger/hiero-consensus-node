...
public final class VirtualMap extends AbstractVirtualRoot implements Labeled, VirtualRoot {
    ...
    public VirtualMap(
        ...
        this.cache = new VirtualNodeCache(
                virtualMapConfig, hashChunkHeight, dataSource::loadHashChunk, leafChunkSize, dataSource::loadLeafChunk);
        this.records = new RecordAccessor(this.metadata, hashChunkHeight, leafChunkSize, this.cache, this.dataSource);
