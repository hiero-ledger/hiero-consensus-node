 ...
 *      ignored
 * @param valueParseMaxSize
 *      Maximum allowed size (in bytes) for parsing a delimited virtual-map value payload.
...
public record VirtualMapConfig(
        ...
        @Min(1) @ConfigProperty(defaultValue = "37748736") int valueParseMaxSize,
