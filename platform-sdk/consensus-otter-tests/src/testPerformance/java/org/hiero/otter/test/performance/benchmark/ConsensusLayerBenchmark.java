...
public class ConsensusLayerBenchmark {
    ...
    private static final int INVOCATION_RATE = 20;
    ...
    void benchmark(@NonNull final TestEnvironment env) {
        ...
        log.info(
                "Starting benchmark: submitting {} transactions for measurement at a rate of {} ops/s...",
                TRANSACTION_COUNT,
                INVOCATION_RATE);
        ...
        throttler.submitWithRate(TRANSACTION_COUNT, INVOCATION_RATE);
