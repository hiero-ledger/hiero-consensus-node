...
import org.hiero.otter.fixtures.app.model.codec.AccountProtoCodec;
import org.hiero.otter.fixtures.app.model.schema.AccountSchema;
...
public final class Account {
    ...
    public int protobufSize() {
        ...
        if ($protobufEncodedSize == -1) {
            int _size = 0;
            // [1] - accountId
            _size += sizeOfMessage(AccountSchema.ACCOUNT_ID, accountId, AccountId.PROTOBUF);
            // [2] - name
    ...
    /**
     * Override the default toString method for Account to match the format of a Java record.
     */
    @Override
