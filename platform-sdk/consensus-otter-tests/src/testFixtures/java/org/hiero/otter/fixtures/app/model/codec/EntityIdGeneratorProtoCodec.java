...
/**
 * Protobuf Codec for EntityIdGenerator model object. Generated based on protobuf schema.
 */
public final class EntityIdGeneratorProtoCodec implements Codec<EntityIdGenerator> {
    /**
    ...
    public @NonNull EntityIdGenerator parse(
        ...
        try {
            ...
            return new EntityIdGenerator(temp_nextId, $unknownFields);
    ...
    /**
     * Write out a EntityIdGenerator model to output stream in protobuf format.
     *
     ...
     */
    public int measureRecord(EntityIdGenerator data) {
