 ...
 */
public final class IssStateProtoCodec implements Codec<IssState> {
    /**
    ...
    public @NonNull IssState parse(
        ...
        try {
            ...
            while (input.hasRemaining()) {
                ...
                switch (tag) {
                    case 8 /* type=0 [UINT64] field=1 [issState] */ -> {
            ...
            return new IssState(temp_issState, $unknownFields);
    ...
    /**
     * Write out a IssState model to output stream in protobuf format.
     *
     ...
     */
    public int measureRecord(IssState data) {
