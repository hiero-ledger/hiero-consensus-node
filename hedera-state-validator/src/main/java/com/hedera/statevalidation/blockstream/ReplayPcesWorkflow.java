...
public final class ReplayPcesWorkflow {
    ...
    public static long run(
        ...
        final PlatformBuilder<?> platformBuilder = new PlatformBuilder(
                platformConfig,
                metrics,
                time,
                rosterHistory,
                ...
                version,
                new PlatformBuilder.PersistenceScope(Hedera.APP_NAME, Hedera.SWIRLD_NAME),
                consensusEventStreamName,
                transactionOffsetNanos);
        final SwirldsPlatform platform = (SwirldsPlatform) platformBuilder.build();
        final ConsensusLayerBuildingBlocks blocks = platformBuilder.getBuildingBlocks();
        ...
        try {
            ...
            blocks.pcesModule().replayPcesEvents(pcesReplayLowerBound, startingRound);
