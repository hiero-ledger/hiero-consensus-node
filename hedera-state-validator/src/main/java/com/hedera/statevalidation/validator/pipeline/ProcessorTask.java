...
public class ProcessorTask implements Callable<Void> {
    ...
    // TODO: this is not a hash store, but a hash chunk store now
    ...
    public ProcessorTask(
        ...
        this.pathToDiskLocationInternalNodes = vds.getIdToDiskLocationHashChunks();
     ...
     */
    // TODO: process hash chunks, not hash records
