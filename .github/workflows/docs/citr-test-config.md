...
[203: [USER] CITR MDLT Ctrl Adhoc](/.github/workflows/203-user-mdlt-controller-adhoc.yaml); the `default_duration` in
...
- 1 hour : nlg-time=21 (mins), nlg-accounts=20000000
- 3 hour: nlg-time=180, nlg-accounts=20000000
- 5 days (MDLT production run): nlg-time=7200, nlg-accounts=100000000

The kickoff (`835`) starts a short smoke with `nlg-time=3`, then relaunches the same command with `-tt 7200m` in the
background for the full 5-day run.
