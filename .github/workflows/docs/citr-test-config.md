...
|------------------------------------------|-----------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|---------------------------------------|
| Compile Code                             | [ZXC: Compile Code](/.github/workflows/zxc-compile-code.yaml)                                       |                                                                                                         | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                |                                       |
| Dependency (Module Info)                 | [ZXC: Compile Code](/.github/workflows/zxc-compile-code.yaml)                                       | `enable-dependency-check: true`                                                                         | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Code Compiles                         |
| Spotless                                 | [ZXC: Compile Code](/.github/workflows/zxc-compile-code.yaml)                                       | `enable-spotless-check: true`                                                                           | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Code Compiles                         |
| MATS - Unit Tests                        | [ZXC: Run Unit Tests](/.github/workflows/zxc-run-unit-tests.yaml)                                   | `enable-unit-tests: true`                                                                               | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`<br/>`codacy-project-token`<br/>`codecov-token` | Dependency (Module Info)<br/>Spotless |
| MATS - Integration Tests                 | [ZXC: Run Integration Tests](/.github/workflows/zxc-run-integration-tests.yaml)                     | `enable-integration-tests: true`<br/>`enable-network-log-capture: true`                                 | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Misc)                 | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-misc: true`<br/>`enable-network-log-capture: true`<br/>`mats-suffix: MATS`           | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Misc Records)         | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-misc-records: true`<br/>`enable-network-log-capture: true`<br/>`mats-suffix: MATS`   | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Crypto)               | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-crypto: true`<br/>`enable-network-log-capture: true`<br/>`mats-suffix: MATS`         | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Simple Fees)          | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-simplefees: true`<br/>`enable-network-log-capture: true`<br/>`mats-suffix: MATS`     | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (ISS)                  | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-iss: true`<br/>`enable-network-log-capture: true`                                    | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Token)                | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-token: true`<br/>`enable-network-log-capture: true`<br/>`mats-suffix: MATS`          | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Smart Contract)       | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-smart-contract: true`<br/>`enable-network-log-capture: true`<br/>`mats-suffix: MATS` | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Restart)              | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-restart: true`<br/>`enable-network-log-capture: true`                                | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - HAPI Tests (Node Death Reconnect) | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                                   | `enable-hapi-tests-nd-reconnect: true`<br/>`enable-network-log-capture: true`                           | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
| MATS - Otter Tests                       | [ZXC: Run Otter Tests](/.github/workflows/zxc-run-otter-tests.yaml)                                 | `enable-fast-otter-tests: true`<br/>`enable-network-log-capture: true`                                  | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | Dependency (Module Info)<br/>Spotless |
...
|                 Test Name                 |                                         Workflow                                          |                                                                                                                                                     Required Parameters                                                                                                                                                     |                                                                                                                Required Workflow Secrets                                                                                                                 |   Precursor Steps   |
|-------------------------------------------|-------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|
| XTS Timing Sensitive Tests                | [ZXC: Run Timing Sensitive Tests](/.github/workflows/zxc-run-timing-sensitive-tests.yaml) | `enable-timing-sensitive-tests: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                                                                        | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate |
| XTS Time Consuming Tests                  | [ZXC: Run Time Consuming Tests](/.github/workflows/zxc-run-time-consuming-tests.yaml)     | `enable-time-consuming-tests: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                                                                          | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate |
| XTS Hammer Tests                          | [ZXC: Run Hammer Tests](/.github/workflows/zxc-run-hammer-tests.yaml)                     | `enable-hammer-tests: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                                                                                  | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate |
| XTS HAPI Tests (Time Consuming)           | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                         | `enable-hapi-tests-time-consuming: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                                                                     | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate |
| XTS HAPI Tests (Block Node Communication) | [ZXC: Run HAPI Tests](/.github/workflows/zxc-run-hapi-tests.yaml)                         | `enable-hapi-tests-bn-communication: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                                                                   | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate |
| XTS Otter Tests                           | [ZXC: Run Otter Tests](/.github/workflows/zxc-run-otter-tests.yaml)                       | `enable-full-otter-tests: true`<br/>`enable-network-log-capture: true`<br/>`ref: <commit-sha>`                                                                                                                                                                                                                              | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                                                                                                                                                   | Fetch XTS Candidate |
