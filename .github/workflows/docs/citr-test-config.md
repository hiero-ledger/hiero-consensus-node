...
| MATS - HAPI Tests (Restart & Quiescence)                            | [805: [CALL] Exec HAPI Tests](/.github/workflows/805-call-execute-hapi-tests.yaml)               | `ref: <commit-sha>`<br/>`enable-hapi-tests-restart: true`<br/>`enable-network-log-capture: true`                        | `access-token`<br/>`gradle-cache-username`<br/>`gradle-cache-password`                                                | build           |
...
| Solo 0.76 to 0.77 Cutover Panel           | [826: [CALL] Solo 076-077 Cutover](/.github/workflows/826-call-solo-076-to-077-cutover.yaml)     | `ref: <commit-sha>`<br/>`solo-version: vars.CITR_SOLO_VERSION`                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                          | Fetch XTS Candidate<br/>Compile Code |
