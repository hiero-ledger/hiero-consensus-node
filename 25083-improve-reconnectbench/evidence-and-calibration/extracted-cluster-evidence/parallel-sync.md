...
| Later reconnect handling | diagnostic_only | Second reconnect is documented separately, but the entire artifact is diagnostic-only after fatal preflight. | `log:podlog_solo-mdlt-n4/network-node1_logs/swirlds.log:276-320`, [Network Disease Preflight](#network-disease-preflight) |
