...
| [StatelessMetric](../src/main/java/org/hiero/metrics/api/StatelessMetric.java)     | Gauge    | Requires zero ore more `DoubleSupplier`/`LongSupplier` (with optional labels), which will be called on export.                     |
