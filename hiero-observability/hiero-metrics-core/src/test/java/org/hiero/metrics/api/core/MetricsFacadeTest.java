...
public class MetricsFacadeTest {
    ...
    class ExportersTests {
        ...
        @Test
        void testEnabledExportManagerWhenNoExporters() {
        ...
        @Test
        void testExportersAreFiltered() {
            Configuration configuration = configBuilder()
                    .withValue("metrics.export.manager.disabledExporters", "pulling1")
                    .build();
            ...
            final PullingMetricsExporter disabledExporter = mock(PullingMetricsExporter.class);
            when(disabledExporter.name()).thenReturn("pulling1");
            when(disabledExporterFactory.createExporter(configuration)).thenReturn(Optional.of(disabledExporter));
            ...
            verify(disabledExporterFactory).createExporter(configuration);
        }
