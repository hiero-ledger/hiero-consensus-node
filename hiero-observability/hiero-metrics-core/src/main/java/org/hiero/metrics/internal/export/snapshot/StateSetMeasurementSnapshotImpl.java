...
/**
 * A default implementation of {@link StateSetMeasurementSnapshot} that holds a set of states represented as boolean values.
 *
 * @param <E> the enum type representing the possible states
 */
public final class StateSetMeasurementSnapshotImpl<E extends Enum<E>> extends BaseMeasurementSnapshot
        implements StateSetMeasurementSnapshot<E> {

    private final E[] enumConstants;
    private final boolean[] states;

    public StateSetMeasurementSnapshotImpl(@NonNull LabelValues dynamicLabelValues, @NonNull E[] enumConstants) {
