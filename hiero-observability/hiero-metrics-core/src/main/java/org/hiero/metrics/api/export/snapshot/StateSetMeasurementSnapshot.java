...
/**
 * A {@link MeasurementSnapshot} that contains a set of states represented as a {@code boolean} values.
 *
 * @param <E> enum type representing possible states
 */
public interface StateSetMeasurementSnapshot<E extends Enum<E>> extends MeasurementSnapshot {
