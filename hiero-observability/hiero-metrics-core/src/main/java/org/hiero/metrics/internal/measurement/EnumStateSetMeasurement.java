...
public final class EnumStateSetMeasurement<E extends Enum<E>> implements StateSetMeasurement<E> {
    ...
    public EnumStateSetMeasurement(@NonNull Set<E> initialStates, @NonNull Class<E> enumClass) {
