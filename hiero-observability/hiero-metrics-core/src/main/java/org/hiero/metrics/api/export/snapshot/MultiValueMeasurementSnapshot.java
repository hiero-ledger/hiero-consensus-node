...
/**
 * A {@link MeasurementSnapshot} that contains multiple {@code double} or {@code long} values,
 ...
 */
public interface MultiValueMeasurementSnapshot extends MeasurementSnapshot {
    ...
    /**
     * @return number of values of the measurement.
     */
    int valuesCount();
