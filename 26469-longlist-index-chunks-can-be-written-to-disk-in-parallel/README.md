...
| 03 | Unforced parallel-chunk baseline | [`linux-benchmark-results-without-force.md`](03-remove-final-force/linux-benchmark-results-without-force.md) | Complete equal-sample matrix; all 280 matching cells return earlier, while the post-return force retains the storage work |
