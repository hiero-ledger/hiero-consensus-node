...
import com.hedera.stateoperator.listener.LoggingTestExecutionListener;
import com.hedera.stateoperator.listener.ReportingListener;
import com.hedera.stateoperator.listener.SummaryGeneratingListener;
...
public class ValidateCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
                .selectors(selectPackage("com.hedera.stateoperator.validators"))
