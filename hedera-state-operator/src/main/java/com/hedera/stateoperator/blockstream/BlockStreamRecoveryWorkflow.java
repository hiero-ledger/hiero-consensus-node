...
package com.hedera.stateoperator.blockstream;

import static com.hedera.services.bdd.junit.support.validators.block.BlockStreamUtils.*;
import static com.hedera.stateoperator.ApplyBlocksCommand.DEFAULT_TARGET_ROUND;
import static com.hedera.stateoperator.blockstream.BlockStreamUtils.mapKeyFor;
import static com.hedera.stateoperator.blockstream.BlockStreamUtils.mapValueFor;
import static com.hedera.stateoperator.blockstream.BlockStreamUtils.queuePushFor;
import static com.hedera.stateoperator.blockstream.BlockStreamUtils.singletonPutFor;
import static com.hedera.stateoperator.parameterresolver.StateResolver.PLATFORM_CONTEXT;
