...
public class ClprGetLedgerConfigurationHandlerTest extends ClprHandlerTestBase {
    ...
    public void setUp() {
        ...
        given(context.createStore(ReadableClprLedgerConfigurationStore.class))
                .willReturn(readableLedgerConfigStore);
        given(context.createStore(ReadableHistoryStore.class))
                .willReturn(readableHistoryStore);
    }
    ...
    void createsEmptyResponse() {
        ...
        final var expectedResponse = Response.newBuilder()
                .clprLedgerConfiguration(ClprGetLedgerConfigurationResponse.newBuilder().header(header))
                .build();
