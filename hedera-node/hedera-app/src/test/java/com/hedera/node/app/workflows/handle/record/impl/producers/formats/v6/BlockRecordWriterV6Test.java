...
final class BlockRecordWriterV6Test extends AppTestBase {
    ...
    void createApp() throws IOException {
        ...
        writer = new BlockRecordWriterV6(config, asAccountString(selfNodeInfo.accountId()), SIGNER, fileSystem);
    ...
    final class ConstructorTests {
        ...
        void nullArgsToConstructorThrows() {
            ...
            assertThatThrownBy(() -> new BlockRecordWriterV6(
                            null, asAccountString(selfNodeInfo.accountId()), signer, fileSystem))
                    .isInstanceOf(NullPointerException.class);
            assertThatThrownBy(() -> new BlockRecordWriterV6(config, null, signer, fileSystem))
                    .isInstanceOf(NullPointerException.class);
            assertThatThrownBy(() -> new BlockRecordWriterV6(
                            config, asAccountString(selfNodeInfo.accountId()), null, fileSystem))
                    .isInstanceOf(NullPointerException.class);
            assertThatThrownBy(() ->
                            new BlockRecordWriterV6(config, asAccountString(selfNodeInfo.accountId()), signer, null))
                    .isInstanceOf(NullPointerException.class);
        }
        ...
        void recordFileVersionMustBeV6() {
            ...
            final var config = buildAndGetConfig();
            assertThatThrownBy(() -> new BlockRecordWriterV6(
                            config, asAccountString(selfNodeInfo.accountId()), SIGNER, fileSystem))
