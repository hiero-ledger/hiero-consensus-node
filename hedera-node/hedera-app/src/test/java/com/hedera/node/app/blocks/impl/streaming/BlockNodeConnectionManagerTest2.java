...
class BlockNodeConnectionManagerTest2 extends BlockNodeCommunicationTestBase {
    ...
    private static final Logger logger = LogManager.getLogger(BlockNodeConnectionManagerTest2.class);
    ...
    void beforeEach() {
        ...
        lenient()
                .when(stateManager.getBlockStreamQueue())
    ...
    void testProcessBlockStreamQueue_emptyQueue() {
        ...
        verify(stateManager).getBlockStreamQueue();
    ...
    void testProcessBlockStreamQueue_withItems_multipleBatches() {
        ...
        verify(stateManager, times(2)).getBlockStreamQueue();
        verify(stateManager, times(numItemsToCreate)).getBlockState(100L);
    ...
    @Test
    void testProcessStreamingToBlockNode_blockEnd_higherPriorityConnectionExists() {
