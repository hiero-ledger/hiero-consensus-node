...
public class WritableMigrationRootHashStoreImpl implements WritableMigrationRootHashStore {
    ...
    private final WritableKVState<MigrationRootHashVoteTransactionBody, MigrationRootHashVoteTally> tallies;
    ...
    @Override
    public void addToTally(@NonNull final MigrationRootHashVoteTransactionBody vote, final long weight) {
        final var key = requireNonNull(vote);
