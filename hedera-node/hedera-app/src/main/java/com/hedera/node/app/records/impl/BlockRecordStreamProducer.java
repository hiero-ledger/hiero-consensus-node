...
public interface BlockRecordStreamProducer extends AutoCloseable {
    ...
    /**
     * Closes the currently open record file, if any, without opening the next one.
     *
     * @param currentBlockNumber the number of the block whose record file should be closed
     */
    void closeCurrentBlock(long currentBlockNumber);
