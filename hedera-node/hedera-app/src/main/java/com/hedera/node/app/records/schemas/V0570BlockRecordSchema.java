 ...
 */
public class V0570BlockRecordSchema extends Schema<SemanticVersion> {
    ...
    public static final int MIGRATION_ROOT_HASH_VOTING_STATE_ID = 57;
    ...
    public static final int MIGRATION_ROOT_HASH_VOTES_STATE_ID = 58;
    ...
    public static final int MIGRATION_ROOT_HASH_TALLIES_STATE_ID = 59;
    ...
    public static final int MIGRATION_WRAPPED_HASHES_QUEUE_STATE_ID = 60;
