...
import com.hederahashgraph.api.proto.java.ConsensusSubmitMessage;
...
public class ConsensusSubmitMessageFeeCalculatorTest {
    ...
    class UpdateTopicTests {
        ...
        void updateTopic() {
            ...
            final var body = TransactionBody.newBuilder().consensusSubmitMessage(op).build();
    ...
    private static FeeSchedule createTestFeeSchedule() {
        return FeeSchedule.DEFAULT
                ...
                .services(makeService(
                        "Consensus",
                        makeServiceFee(
                                HederaFunctionality.CONSENSUS_SUBMIT_MESSAGE, 498500000L, makeExtraIncluded(Extra.SIGNATURES, 1))))
                .build();
    }
