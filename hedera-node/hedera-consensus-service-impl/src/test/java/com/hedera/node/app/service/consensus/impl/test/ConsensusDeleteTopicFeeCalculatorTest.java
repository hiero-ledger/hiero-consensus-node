...
public class ConsensusDeleteTopicFeeCalculatorTest {
    ...
    class DeleteTopicTests {
        ...
        void calculateFee() {
            ...
            final var body = TransactionBody.newBuilder().consensusDeleteTopic(op).build();
    ...
    private static FeeSchedule createTestFeeSchedule() {
        return FeeSchedule.DEFAULT
                ...
                .services(makeService(
                        "Consensus",
                        makeServiceFee(
                                HederaFunctionality.CONSENSUS_DELETE_TOPIC, 498500000L, makeExtraIncluded(Extra.SIGNATURES, 1))))
                .build();
    }
}
