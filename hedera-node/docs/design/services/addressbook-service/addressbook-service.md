...
- `grpc_proxy_endpoint`: A list of service endpoints for gRPC proxy calls. These endpoints represent the published gRPC proxy endpoints to which clients may submit transactions.
