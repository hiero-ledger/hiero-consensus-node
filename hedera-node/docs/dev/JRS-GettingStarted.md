...
Naming conventions described in [file](https://github.com/hashgraph/jrs-legacy/blob/main/docs/regression-test-naming-standards.md) are required to be followed for both types of configuration JSONs.
...
**NOTE** : To validate the regression results follow steps defined in [regression-validation-checklist.md](https://github.com/hashgraph/jrs-legacy/blob/main/docs/regression-validation-checklist.md).
