...
public interface TokenServiceApi {
     ...
     * @param requireContract if true, the account must be a contract
     */
    void updateLambdaStorageSlots(@NonNull AccountID accountId, int netChangeInSlotsUsed, boolean requireContract);
