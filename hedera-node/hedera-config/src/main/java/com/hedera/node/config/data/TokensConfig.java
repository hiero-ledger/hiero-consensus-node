...
public record TokensConfig(
        @ConfigProperty(defaultValue = "200000000") @NetworkProperty
        long maxAggregateRels,

        @ConfigProperty(defaultValue = "1000000") @NetworkProperty
        long maxNumber,

        @ConfigProperty(defaultValue = "1000") @NetworkProperty
        int maxPerAccount,

        @ConfigProperty(defaultValue = "100") @NetworkProperty
        int maxSymbolUtf8Bytes,
        ...
        @ConfigProperty(defaultValue = "1000") @NetworkProperty
        int maxRelsPerInfoQuery,

        @ConfigProperty(value = "reject.enabled", defaultValue = "true") @NetworkProperty
        boolean tokenRejectEnabled,

        @ConfigProperty(value = "nfts.maxMetadataBytes", defaultValue = "100") @NetworkProperty
        int nftsMaxMetadataBytes,

        @ConfigProperty(value = "nfts.maxBatchSizeBurn", defaultValue = "10") @NetworkProperty
        int nftsMaxBatchSizeBurn,

        @ConfigProperty(value = "nfts.maxBatchSizeWipe", defaultValue = "10") @NetworkProperty
        int nftsMaxBatchSizeWipe,
        ...
        @ConfigProperty(value = "nfts.maxQueryRange", defaultValue = "100") @NetworkProperty
        long nftsMaxQueryRange,

        @ConfigProperty(value = "nfts.mintThrottleScaleFactor", defaultValue = "5:2")
        ScaleFactor nftsMintThrottleScaleFactor,

        @ConfigProperty(defaultValue = "20000000") @NetworkProperty
        long maxAllowedPendingAirdrops,
        ...
        @ConfigProperty(value = "maxMetadataBytes", defaultValue = "100") @NetworkProperty
        ...
        @ConfigProperty(value = "airdrops.enabled", defaultValue = "true") @NetworkProperty
        boolean airdropsEnabled,
        ...
        boolean countingGetBalanceThrottleEnabled) {}
