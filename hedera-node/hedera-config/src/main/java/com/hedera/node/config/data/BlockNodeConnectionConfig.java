 ...
 * @param numBlocksBehindLowThreshold number of blocks a block node can be behind before the node is placed in a basic cool down
 * @param numBlocksBehindHighThreshold number of blocks a block node can be behind before the node is placed in an extended cool down
 */
// spotless:off
...
public record BlockNodeConnectionConfig(
        ...
        @ConfigProperty(defaultValue = "50") @Min(0) @NetworkProperty int numBlocksBehindLowThreshold,
        @ConfigProperty(defaultValue = "100") @Min(0) @NetworkProperty int numBlocksBehindHighThreshold) {
}
// spotless:on
