 ...
 *
 * @param maxBufferedBlocks the maximum number of blocks that can be buffered before the buffer is considered full
...
public record BlockBufferConfig(
        @ConfigProperty(defaultValue = "150") @Min(0) @NetworkProperty int maxBufferedBlocks,
