...
class CallOutcomeTest {
    ...
    void setsAbortCallResult() {
        final var abortedCall = new CallOutcome(
                ContractFunctionResult.DEFAULT, INSUFFICIENT_GAS, CALLED_CONTRACT_ID, null, null);
    ...
    void recognizesCreatedIdWhenEvmAddressIsSet() {
        ...
        final var outcome =
                new CallOutcome(SUCCESS_RESULT.asProtoResultOf(updater), SUCCESS, null, null, null);
