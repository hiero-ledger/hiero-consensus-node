...
class SeiVerifierCallAttemptTest extends CallAttemptTestBase {
    @Test
    void reportsSeiVerifierKindAndSelf() {
        given(addressIdConverter.convertSender(OWNER_BESU_ADDRESS)).willReturn(A_NEW_ACCOUNT_ID);

        final var subject = new SeiVerifierCallAttempt(
                ...
                new CallAttemptOptions<>(
                        ContractID.newBuilder()
                                ...
                                .build(),
                        OWNER_BESU_ADDRESS,
                        Address.fromHexString(SEI_VERIFIER_EVM_ADDRESS),
                        OWNER_BESU_ADDRESS,
                        false,
                        mockEnhancement(),
                        DEFAULT_CONFIG,
        ...
        assertThat(subject.systemContractKind()).isEqualTo(SystemContractMethod.SystemContract.SEI_VERIFIER);
