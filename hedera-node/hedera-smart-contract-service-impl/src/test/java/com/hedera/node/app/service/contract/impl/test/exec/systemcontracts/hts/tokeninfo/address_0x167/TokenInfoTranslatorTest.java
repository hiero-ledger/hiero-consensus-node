...
package com.hedera.node.app.service.contract.impl.test.exec.systemcontracts.hts.tokeninfo.address_0x167;
...
class TokenInfoTranslatorTest extends CallAttemptTestBase {
    ...
    void matchesTokenInfoTranslatorTest() {
        attempt = createHtsCallAttempt(Bytes.wrap(TOKEN_INFO_167.selector()), subject);
    ...
    void callFromTest() {
        ...
        final Bytes inputBytes = Bytes.wrapByteBuffer(TOKEN_INFO_167.encodeCall(tuple));
