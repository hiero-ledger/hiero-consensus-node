...
/**
 * Factory to create a new {@link BesuQBFTVerifierCallAttempt} for a given input and message frame.
 */
@Singleton
public class BesuQBFTVerifierCallFactory implements CallFactory<BesuQBFTVerifierCallAttempt> {
    ...
    private final List<CallTranslator<BesuQBFTVerifierCallAttempt>> callTranslators;
    private final SystemContractMethodRegistry systemContractMethodRegistry;

    @Inject
    public BesuQBFTVerifierCallFactory(
            ...
            @NonNull @Named("BesuQBFTVerifierTranslators")
                    final List<CallTranslator<BesuQBFTVerifierCallAttempt>> callTranslators,
    ...
    @Override
    public @NonNull BesuQBFTVerifierCallAttempt createCallAttemptFrom(
        ...
        return new BesuQBFTVerifierCallAttempt(
                input,
