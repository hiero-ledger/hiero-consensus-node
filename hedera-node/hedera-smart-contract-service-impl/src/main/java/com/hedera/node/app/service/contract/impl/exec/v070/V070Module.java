...
public interface V070Module {
    ...
    static ContractCreationProcessor provideContractCreationProcessor(
            @ServicesV070 @NonNull final HEVM evm, @NonNull final List<ContractValidationRule> validationRules) {
    ...
    @Binds
    @ServicesV070
    FeatureFlags bindFeatureFlags(Version070FeatureFlags featureFlags);
    ...
    static Operation provideSelfDestructOperation(
            @NonNull final GasCalculator gasCalculator, @ServicesV070 @NonNull final AddressChecks addressChecks) {
