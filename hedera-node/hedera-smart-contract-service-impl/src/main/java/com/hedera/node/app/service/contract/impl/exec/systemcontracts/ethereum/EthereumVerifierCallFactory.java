...
/**
 * Factory to create a new {@link EthereumVerifierCallAttempt} for a given input and message frame.
 */
@Singleton
public class EthereumVerifierCallFactory implements CallFactory<EthereumVerifierCallAttempt> {
    ...
    private final List<CallTranslator<EthereumVerifierCallAttempt>> callTranslators;
    private final SystemContractMethodRegistry systemContractMethodRegistry;

    @Inject
    public EthereumVerifierCallFactory(
            ...
            @NonNull @Named("EthereumVerifierTranslators")
                    final List<CallTranslator<EthereumVerifierCallAttempt>> callTranslators,
    ...
    @Override
    public @NonNull EthereumVerifierCallAttempt createCallAttemptFrom(
        ...
        return new EthereumVerifierCallAttempt(
                input,
