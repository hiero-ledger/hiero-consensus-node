...
public class CodeV2 implements Code {
    ...
    public static CodeV2 make(byte[] codes, int off, int len) {
        ...
        synchronized (FREE) {
            ...
            if( old != null ) {
                // Got a prior, so under lock, push code back on the free list
                HITS++;
    ...
    public static CodeV2 make(Account act) {
    ...
    // Mark it as obviously freed (_codes=null, _hash=0) and append to the FREE
