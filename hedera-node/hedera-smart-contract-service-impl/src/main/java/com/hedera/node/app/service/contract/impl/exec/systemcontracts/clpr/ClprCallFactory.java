...
/**
 * Factory to create a new {@link ClprCallAttempt} for a given input and message frame.
 */
@Singleton
public class ClprCallFactory implements CallFactory<ClprCallAttempt> {
    ...
    private final List<CallTranslator<ClprCallAttempt>> callTranslators;
    private final SystemContractMethodRegistry systemContractMethodRegistry;

    @Inject
    public ClprCallFactory(
            @NonNull final SyntheticIds syntheticIds,
            @NonNull final CallAddressChecks addressChecks,
            @NonNull final VerificationStrategies verificationStrategies,
            @NonNull @Named("ClprTranslators") final List<CallTranslator<ClprCallAttempt>> callTranslators,
    ...
    @Override
    public @NonNull ClprCallAttempt createCallAttemptFrom(
