...
public interface VXXXModule {
    ...
    //        @ServicesVXXX @NonNull final EVM evm, @NonNull final Set<ContractValidationRule> validationRules) {
    ...
    //        @ServicesVXXX @NonNull final EVM evm,
    //        @ServicesVXXX @NonNull final FeatureFlags featureFlags,
    //        @ServicesVXXX @NonNull final AddressChecks addressChecks,
    //        @ServicesVXXX @NonNull final PrecompileContractRegistry registry,
    ...
    //        @ServicesVXXX @NonNull final Set<Operation> customOperations,
    ...
    //@Binds
    //@ServicesVXXX
    //FeatureFlags bindFeatureFlags(VersionXXXFeatureFlags featureFlags);
    //
    //@Binds
    //@ServicesVXXX
