...
public class ContractMetrics {
    ...
    private final ConcurrentHashMap<HederaFunctionality, Counter> rejectedTxsLackingIntrinsicGas = new ConcurrentHashMap<>();
    ...
    private final Map<SystemContractMethod.SystemContract, Counter[]> systemContractMethodCounters = new ConcurrentHashMap<>();

    // Counters for DIRECT vs PROXY usage
    private final Map<SystemContractMethod.CallVia, Counter[]> systemContractMethodCountersVia = new ConcurrentHashMap<>();
    ...
    private final Map<SystemContractMethod.Category, Counter[]> systemContractERCTypeCounters = new ConcurrentHashMap<>();
    ...
    private final Map<SystemContractMethod, EnumSet<SystemContractMethod.Category>> systemContractMethodGroupMembers =
            new ConcurrentHashMap<>();
    private final Map<SystemContractMethod.Category, Counter[]> systemContractMethodGroupCounters = new ConcurrentHashMap<>();
