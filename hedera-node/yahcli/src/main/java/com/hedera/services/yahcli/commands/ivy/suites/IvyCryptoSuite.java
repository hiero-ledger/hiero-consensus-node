...
public class IvyCryptoSuite extends AbstractIvySuite {
    ...
    public IvyCryptoSuite(@NonNull Map<String, String> specConfig, @NonNull ScenariosConfig scenariosConfig, @NonNull Supplier<String> nodeAccountSupplier, @NonNull Runnable persistUpdatedScenarios, @NonNull LongFunction<PrivateKey> accountKeyLoader) {
