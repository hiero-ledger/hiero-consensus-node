...
public class TraceabilitySuite {
    ...
    //                        BigInteger.TWO,
    //                        BigInteger.TWO),
    //                contractCustomCreate(TRACEABILITY, SECOND, BigInteger.ZERO, BigInteger.ZERO,
    ...
    //                        BigInteger.ZERO,
    //                        BigInteger.valueOf(12)),
    //                contractCustomCreate(TRACEABILITY, THIRD, BigInteger.ZERO, BigInteger.valueOf(11),
    // BigInteger.ZERO)
    ...
    //                                                                getNestedContractAddress(TRACEABILITY + "B",
    // spec)),
    //                                                        hexedSolidityAddressToHeadlongAddress(
    //                                                                getNestedContractAddress(TRACEABILITY + "C",
    // spec))))
    //                                                .build(),
    //                                        ContractAction.newBuilder()
    //                                                .setCallType(CALL)
    ...
    //                                                        "callAddressGetSlot0",
    //                                                        hexedSolidityAddressToHeadlongAddress(
    //                                                                getNestedContractAddress(TRACEABILITY + THIRD,
    // spec))))
    //                                                .build(),
    //                                        ContractAction.newBuilder()
    //                                                .setCallType(CALL)
    ...
    //                        BigInteger.ZERO,
    //                        BigInteger.valueOf(99)),
    //                contractCustomCreate(TRACEABILITY, THIRD, BigInteger.ZERO, BigInteger.valueOf(88),
    // BigInteger.ZERO)
    //                        .via(THIRD_CREATE_TXN),
    //                expectContractStateChangesSidecarFor(
    //                        THIRD_CREATE_TXN,
    ...
    //                                                        "callAddressGetSlot2",
    //                                                        hexedSolidityAddressToHeadlongAddress(
    //                                                                getNestedContractAddress(TRACEABILITY + SECOND,
    // spec))))
    //                                                .build(),
    //                                        ContractAction.newBuilder()
    //                                                .setCallType(CALL)
    ...
    //                                TRACEABILITY_CALLCODE, SECOND, BigInteger.ZERO, BigInteger.ZERO,
    // BigInteger.valueOf(12))
    //                        .via(SECOND_CREATE_TXN),
    //                expectContractStateChangesSidecarFor(
    //                        SECOND_CREATE_TXN,
    ...
    //                        BigInteger.valueOf(12)),
    //                contractCustomCreate(
    //                                TRACEABILITY_CALLCODE, THIRD, BigInteger.valueOf(4), BigInteger.ONE,
    // BigInteger.ZERO)
    //                        .via(THIRD_CREATE_TXN),
    //                expectContractStateChangesSidecarFor(
    //                        THIRD_CREATE_TXN,
    ...
    //                                        TRACEABILITY_CALLCODE,
    //                                        "eetScenario7",
    //                                        asHeadlongAddress(getNestedContractAddress(TRACEABILITY_CALLCODE + "B",
    // spec)),
    //                                        asHeadlongAddress(getNestedContractAddress(TRACEABILITY_CALLCODE + "C",
    // spec)))
    //                                .gas(1_000_000)
    //                                .via(TRACEABILITY_TXN))),
    //                expectContractStateChangesSidecarFor(
    ...
    //                                                        spec.registry().getContractId(TRACEABILITY_CALLCODE))
    //                                                .setOutput(uint256ReturnWithValue(BigInteger.valueOf(55)))
    //                                                .setInput(encodeFunctionCall(TRACEABILITY_CALLCODE,
    // GET_ZERO_SLOT))
    //                                                .build(),
    //                                        ContractAction.newBuilder()
    //                                                .setCallType(CALL)
    ...
    //                                                .setOutput(EMPTY)
    //                                                .setInput(encodeFunctionCall(
    //                                                        TRACEABILITY_CALLCODE, SET_ZERO_SLOT,
    ...
    //                                                        spec.registry().getContractId(TRACEABILITY + THIRD))
    //                                                .setRevertReason(EMPTY)
    //                                                .setInput(encodeFunctionCall(TRACEABILITY,
    ...
    //                            log.info("Contract reported TestContract" + " initcode is {} bytes",
    // tcInitcode.length);
    //                        })),
    //                sourcing(() -> contractCallLocal(
    ...
    //                        })),
    //                sourcing(() -> contractCall(contract, DEPLOY, testContractInitcode.get(),
    // BigInteger.valueOf(salt))
    //                        .payingWith(GENESIS)
    //                        .gas(4_000_000L)
    //                        .sending(tcValue)
    ...
    //                                                .setRevertReason(EMPTY)
    //                                                .setInput(encodeFunctionCall(
    //                                                        REVERTING_CONTRACT, "createContract",
    // BigInteger.valueOf(4)))
    //                                                .build(),
    //                                        ContractAction.newBuilder()
    //                                                .setCallType(CREATE)
    ...
    //                                        .setRevertReason(EMPTY)
    //                                        .build())))),
    //                expectFailedContractBytecodeSidecarFor(FIRST_CREATE_TXN, REVERTING_CONTRACT,
    // BigInteger.valueOf(4)));
    //    }
    //
    //    @HapiTest
    ...
    //                                                .setRecipientContract(
    //                                                        spec.registry().getContractId(REVERTING_CONTRACT))
    //                                                .setInput(encodeFunctionCall(REVERTING_CONTRACT,
    // "callingWrongAddress"))
    //                                                .build(),
    //                                        ContractAction.newBuilder()
    //                                                .setCallType(PRECOMPILE)
    ...
    //                        .exposingCreatedIdTo(
    //                                idLit ->
    // tiqMirrorAddr.set(asHexedSolidityAddress(HapiPropertySource.asToken(idLit)))),
    //                mintToken(
    //                        tokenInQuestion,
