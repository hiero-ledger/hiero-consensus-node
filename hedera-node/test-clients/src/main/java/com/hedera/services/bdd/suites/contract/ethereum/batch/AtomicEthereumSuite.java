...
public class AtomicEthereumSuite {
    ...
    //                createLargeFile(GENESIS, TOKEN_CREATE_CONTRACT,
    ...
    //                getAccountInfo(RELAYER).has(accountWith().expectedBalanceWithChargedUsd(ONE_HUNDRED_HBARS, 0,
    // 0.1)));
    //    }
    //
    //    @HapiTest
    ...
    //                                            PAY_RECEIVABLE_CONTRACT, "deposit",
    ...
    //                            .hasTinyBars(
    //                                    changeFromSnapshot(senderBalance, success ? (-DEPOSIT_AMOUNT - senderCharged)
    // : 0));
    ...
    //                sourcing(() -> contractCreate(HELLO_WORLD_MINT_CONTRACT,
    ...
    //                    final var expectedFirstChildContractAddress = contractAddress(expectedParentContractAddress,
    // 1);
    //                    final var expectedSecondChildContractAddress = contractAddress(expectedParentContractAddress,
    // 2);
    //                    final var expectedThirdChildContractAddress = contractAddress(expectedParentContractAddress,
    // 3);
    //
    ...
    // CommonUtils.hex(asEvmAddress(secondChildId.getContractNum()));
    ...
    //        //             ^^^^ 10000000000000000000 wasn't enough to pay the tx fee, so changed the leading `8` to an
    // `F`
