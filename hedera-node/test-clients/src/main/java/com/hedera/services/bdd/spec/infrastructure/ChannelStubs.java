...
public record ChannelStubs(
        ...
        @NonNull org.hiero.hapi.interledger.clpr.protoc.ClprServiceGrpc.ClprServiceBlockingStub clprSvcStubs) {
    ...
    public ChannelStubs {
        ...
        Objects.requireNonNull(clprSvcStubs);
    }
    ...
    public static ChannelStubs from(
        ...
        return new ChannelStubs(
                ...
                org.hiero.hapi.interledger.clpr.protoc.ClprServiceGrpc.newBlockingStub(channel));
    }
}
