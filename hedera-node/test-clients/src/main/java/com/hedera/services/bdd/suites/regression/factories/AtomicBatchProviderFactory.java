...
//                                RandomFile.DEFAULT_CEILING_NUM, props))
...
//                        new RandomToken(tokens, allAccounts, tokenAdminAccounts)
                        //                    new RandomTokenAssociation(tokens, tokenAdminAccounts,
                        // tokenRels, customOutcomes)
                        //                        .ceiling(intPropOrElse(
    ...
    // TODO; create the same fuzzy method as the above but with random selected operations(not all of them)
