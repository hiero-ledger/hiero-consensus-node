...
public class MultiNetworkIsolationSuite {
    ...
    Stream<DynamicTest> threeNetworkIsolation(
        ...
        return multiHapiTest(netA, netB, netC)
                ...
                .on("NET_B", QueryVerbs.getAccountBalance(acctA::get)
                        .hasAnswerOnlyPrecheck(ResponseCodeEnum.INVALID_ACCOUNT_ID))
                .on("NET_C", QueryVerbs.getAccountBalance(acctA::get)
                        .hasAnswerOnlyPrecheck(ResponseCodeEnum.INVALID_ACCOUNT_ID))
                ...
                .on("NET_A", QueryVerbs.getAccountBalance(acctB::get)
                        .hasAnswerOnlyPrecheck(ResponseCodeEnum.INVALID_ACCOUNT_ID))
                .on("NET_C", QueryVerbs.getAccountBalance(acctB::get)
                        .hasAnswerOnlyPrecheck(ResponseCodeEnum.INVALID_ACCOUNT_ID))
                ...
                .on("NET_A", QueryVerbs.getAccountBalance(acctC::get)
                        .hasAnswerOnlyPrecheck(ResponseCodeEnum.INVALID_ACCOUNT_ID))
                .on("NET_B", QueryVerbs.getAccountBalance(acctC::get)
                        .hasAnswerOnlyPrecheck(ResponseCodeEnum.INVALID_ACCOUNT_ID))
                .asDynamicTests("three-network-isolation");
    }
    ...
    Stream<DynamicTest> independentLedgerCounters(
        ...
        return multiHapiTest(netAlpha, netBeta, netGamma)
                .on(
                        "NET_ALPHA",
                ...
                .asDynamicTests("independent-ledger-counters");
    }
}
