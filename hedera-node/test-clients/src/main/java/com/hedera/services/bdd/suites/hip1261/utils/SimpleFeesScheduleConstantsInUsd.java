...
public class SimpleFeesScheduleConstantsInUsd {
    ...
    public static final double TOKEN_CREATE_FUNGIBLE_FEE_USD = 0.9999;
    public static final double TOKEN_CREATE_NFT_FEE_USD = 1.9999;
    public static final double TOKEN_MINT_FUNGIBLE_FEE_USD = 0.0;
    ...
    public static final double CRYPTO_TRANSFER_BASE_FUNGIBLE_FEE_USD = 0.0009;
    public static final double CRYPTO_TRANSFER_BASE_NFT_FEE_USD = 0.0009;
    public static final double CRYPTO_TRANSFER_BASE_FUNGIBLE_CUSTOM_FEES_FEE_USD = 0.0019;
    public static final double CRYPTO_TRANSFER_BASE_NFT_CUSTOM_FEES_FEE_USD = 0.0019;
...
//    public static final double STANDARD_FT_FEE_USD = 0.00001;
...
//    public static final double CUSTOM_FEE_NFT_FEE_USD = 0.00101;
    ...
    public static final long CRYPTO_TRANSFER_INCLUDED_BASE_FUNGIBLE = 0L;
    public static final long CRYPTO_TRANSFER_INCLUDED_BASE_NFT = 0L;
    public static final long CRYPTO_TRANSFER_INCLUDED_BASE_FUNGIBLE_CUSTOM_FEES = 0L;
    public static final long CRYPTO_TRANSFER_INCLUDED_BASE_NFT_CUSTOM_FEES = 0L;
    public static final long CRYPTO_TRANSFER_INCLUDED_HOOK_EXECUTION = 0L;
    public static final long CRYPTO_TRANSFER_INCLUDED_HOOK_UPDATES = 0L;
