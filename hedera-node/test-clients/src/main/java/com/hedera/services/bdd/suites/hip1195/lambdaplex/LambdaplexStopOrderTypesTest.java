...
import static com.hedera.services.bdd.suites.hip1195.lambdaplex.LambdaplexVerbs.FillParty.makingSeller;
import static com.hedera.services.bdd.suites.hip1195.lambdaplex.LambdaplexVerbs.FillParty.takingBuyer;
 ...
 * duplication with {@link LambdaplexCoreOrderTypesTest} to keep the test cases more self-contained.)
 * <p>
...
public class LambdaplexStopOrderTypesTest implements InitcodeTransform {
    ...
    @HapiTest
    final Stream<DynamicTest> pokeWithOracleOpensMarketStop() {
