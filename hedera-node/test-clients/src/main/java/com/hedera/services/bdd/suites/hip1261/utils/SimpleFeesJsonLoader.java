...
public class SimpleFeesJsonLoader {
    /**
     * Loads a {@link SimpleFeesJsonSchema} from a resource in the classpath.
     *
     * @param resourcePath the path to the JSON resource (e.g. "/fees/simpleFees.json")
     * @return parsed {@link SimpleFeesJsonSchema} instance
    ...
    /**
     * Loads a {@link SimpleFeesJsonSchema} from a file path on disk.
     *
    ...
    /**
     * Parses a {@link SimpleFeesJsonSchema} directly from a JSON string.
     *
