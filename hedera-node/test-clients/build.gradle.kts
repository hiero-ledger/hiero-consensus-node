...
val prCheckPropOverrides =
    mapOf(
        ...
        "hapiTestTimeConsumingSerial" to "tss.forceMockSignatures=true,blockStream.quiescedHeartbeatInterval=PT3S,quiescence.enabled=true,staking.periodMins=1440,nodes.nodeRewardsEnabled=false",
