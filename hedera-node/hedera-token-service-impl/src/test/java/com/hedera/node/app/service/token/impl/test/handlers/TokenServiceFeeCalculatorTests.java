...
public class TokenServiceFeeCalculatorTests {
    ...
    void createCommonToken() {
        ...
        final var body = TransactionBody.newBuilder()
                .tokenCreation(TokenCreateTransactionBody.newBuilder()
                        ...
                        .build())
                .build();
        final var result = feeCalculator.calculateTxFee(body, SimpleFeeContextImpl.fromFeeContext(calculatorState));
    ...
    void createUniqueToken() {
        ...
        final var txBody2 = TransactionBody.newBuilder()
                ...
                .build();
        final var result = feeCalculator.calculateTxFee(txBody2, SimpleFeeContextImpl.fromFeeContext(calculatorState));
    ...
    void associateToken() {
        ...
        final var result = feeCalculator.calculateTxFee(txnBody, SimpleFeeContextImpl.fromFeeContext(calculatorState));
        assertNotNull(result);
    ...
    void tokenGetInfo() {
        ...
        final var result =
                feeCalculator.calculateQueryFee(queryBody, SimpleFeeContextImpl.fromQueryContext(queryContext));
        ;
