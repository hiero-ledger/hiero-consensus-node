...
/** Tests for {@link V0710TokenSchema}. */
...
class V0710TokenSchemaTest {
    ...
    @LoggingSubject
    private final V0710TokenSchema subject = new V0710TokenSchema();
    ...
    void testStatesToCreate() {
        ...
        assertThat(nativeCoinDecimalsDef.stateKey()).isEqualTo(V0710TokenSchema.NATIVE_COIN_DECIMALS_KEY);
    ...
    @Test
    @DisplayName("V0710TokenSchema.NATIVE_COIN_DECIMALS_STATE_ID should match SingletonType ordinal")
    void testNativeCoinDecimalsStateId() {
        assertThat(V0710TokenSchema.NATIVE_COIN_DECIMALS_STATE_ID).isEqualTo(57);
    }
    ...
    void testMigrateWhenStateMissing() {
        ...
        given(previousStates.contains(V0710TokenSchema.NATIVE_COIN_DECIMALS_STATE_ID))
                .willReturn(false);
    ...
    void testMigrateWhenStateValueNull() {
        ...
        given(previousStates.contains(V0710TokenSchema.NATIVE_COIN_DECIMALS_STATE_ID))
                .willReturn(true);
        given(previousStates.<NativeCoinDecimals>getSingleton(V0710TokenSchema.NATIVE_COIN_DECIMALS_STATE_ID))
