...
class V069TokenSchemaTest {

    private final V069TokenSchema subject = new V069TokenSchema();
    ...
    void verifyStatesToCreate() {
        ...
        assertThat(def.stateKey()).isEqualTo(V069TokenSchema.INDIRECT_KEY_USERS_KEY);
