...
class CryptoGetAccountRecordsFeeCalculatorTest {
    ...
    void setUp() {
        ...
        feeCalculator = new SimpleFeeCalculatorImpl(testSchedule, Set.of(new CryptoGetAccountRecordsFeeCalculator()));
    }
    ...
    class CryptoGetAccountRecordsTests {
        ...
        void calculateQueryFeeBasic() {
            ...
            // When
            final var result = feeCalculator.calculateQueryFee(query, feeContext);

            // Then: node=100000, network=200000, service=1000000 ($0.0001 USD)
    ...
    @Test
    @DisplayName("getTransactionType returns null for query calculator")
    void getTransactionTypeReturnsNull() {
        final var calculator = new CryptoGetAccountRecordsFeeCalculator();
        assertThat(calculator.getTransactionType()).isNull();
    }
