...
class CryptoUpdateFeeCalculatorTest {
    ...
    class CryptoUpdateTests {
        ...
        void calculateTxFeeWithNoKeyUpdate() {
            ...
            assertThat(result.nodeTotalTC()).isEqualTo(100000L);
            assertThat(result.serviceTotalTC()).isEqualTo(1200000L); // baseFee from production config
            assertThat(result.networkTotalTC()).isEqualTo(900000L);
        }
        ...
        void calculateTxFeeWithSimpleKey() {
            ...
            assertThat(result.nodeTotalTC()).isEqualTo(1100000L);
            assertThat(result.serviceTotalTC()).isEqualTo(1200000L);
            assertThat(result.networkTotalTC()).isEqualTo(9900000L);
        }
        ...
        void calculateTxFeeWithKeyList() {
            ...
            assertThat(result.serviceTotalTC()).isEqualTo(201200000L);
        }
        ...
        void calculateTxFeeWithKeysOverage() {
            ...
            assertThat(result.serviceTotalTC()).isEqualTo(401200000L);
            assertThat(result.nodeTotalTC()).isEqualTo(100000L);
            assertThat(result.networkTotalTC()).isEqualTo(900000L);
        }
        ...
        void calculateTxFeeWithHookCreations() {
            ...
            assertThat(result.serviceTotalTC()).isEqualTo(21200000L);
            assertThat(result.nodeTotalTC()).isEqualTo(100000L);
            assertThat(result.networkTotalTC()).isEqualTo(900000L);
        }
