...
public class V0610TokenSchema extends Schema<SemanticVersion> {
    ...
    public static void dispatchSynthNodeRewards(
        ...
        final var activeNodeAccountIds = nodeGroups.activeNodeAccountIds().stream().toList();
        final var inactiveNodeAccountIds = nodeGroups.inactiveNodeAccountIds().stream().toList();
