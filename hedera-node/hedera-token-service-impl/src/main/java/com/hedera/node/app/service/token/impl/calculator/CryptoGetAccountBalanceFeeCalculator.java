...
/**
 * Fee calculator for {@link HederaFunctionality#CRYPTO_GET_ACCOUNT_BALANCE} queries.
 * <p>
 * Note: This is a free query (extends FreeQueryHandler), but we provide
...
public class CryptoGetAccountBalanceFeeCalculator implements QueryFeeCalculator {
    ...
    public Query.QueryOneOfType getQueryType() {
        return Query.QueryOneOfType.CRYPTOGET_ACCOUNT_BALANCE;
    }
}
