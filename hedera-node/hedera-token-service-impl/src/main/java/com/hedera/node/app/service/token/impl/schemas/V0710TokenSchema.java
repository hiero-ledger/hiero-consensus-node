...
/**
 * Token service schema for version 0.71.0, which adds the {@code NATIVE_COIN_DECIMALS} singleton
 * to persist the native coin's decimal precision at genesis.
 */
public class V0710TokenSchema extends Schema<SemanticVersion> {
    ...
    /** Creates a new {@link V0710TokenSchema}. */
